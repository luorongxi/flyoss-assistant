...
腾飞智能助手是基于钉钉平台的AI助手，集成了大型语言模型、知识库、记忆系统和多种工具能力，提供智能问答、任务处理和信息检索服务。
...
## 🧩 系统架构
![架构图](docs/images/flyoss_assistant_framework.png)

## 🎢 钉钉消息处理流程
![钉钉消息处理流程](docs/images/flyoss_dingtalk_message_handle.png)

## 📦 Agent决策流程
![Agent决策流程](docs/images/flyoss_agent_decision_flow.png)

## ✈️ 开源版与企业版

![功能区别_1](docs/images/flyoss_open_and_professional_1.png)
![功能区别_2](docs/images/flyoss_open_and_professional_2.png)
